...
/** 
 *
 * \defgroup icub_gazeTracking gazeTracking
 * @ingroup icub_cognitiveinteraction
 *
 * This is a module that receives the RGB image from input connection and sends it back to output connection. The purpose
 * of the module is to track the gaze of the human counter part.
 * 
 *
 * 
 ...
 *
 * - \c from \c gazeTrackingRateThread.ini \n 
 *   specifies the configuration file
 *
 * - \c context \c gazeTrackingRateThread/conf \n
 *   specifies the sub-path from \c $ICUB_ROOT/icub/app to the configuration file
 *
 * - \c name \c gazeTrackingRateThread \n 
 *   specifies the name of the gazeTrackingRateThread (used to form the stem of gazeTrackingRateThread port names)  
 *
 * - \c robot \c icub \n 
 ...
 *  <b>Input ports</b>
 *
 *  - \c /gazeTrackingRateThread \n
 *    This port is used to change the parameters of the gazeTrackingRateThread at run time or stop the gazeTrackingRateThread. \n
 ...
 *    The port can be used by other gazeTrackingRateThreads but also interactively by a user through the yarp rpc directive, viz.: \c yarp \c rpc \c /gazeTrackingRateThread
 *    This opens a connection from a terminal to the port and allows the user to then type in commands and receive replies.
 *       
 *  - \c /gazeTrackingRateThread/image:i \n
 *
 * <b>Output ports</b>
 *
 *  - \c /gazeTrackingRateThread \n
 *    see above
 *
 *  - \c /gazeTrackingRateThread/image:o \n
 *
 * <b>Port types</b>
 *
 * The functional specification only names the ports to be used to communicate with the gazeTrackingRateThread 
 ...
 *
 * \c gazeTracking.ini  in \c $COGNITIVEINTERACTION_ROOT/share/cognitiveinteraction/context/gazeTracking \n
 * \c icubEyes.ini  in \c $ICUB_ROOT/app/gazeTrackingRateThread/conf
 * 
 ...
 * 
 * <tt>gazeTracking --name gazeTracking --context gazeTracking --from gazeTracking.ini --robot icub</tt>
 *
 * \author Rea Francesco
 *
 * Copyright (C) 2015 RobotCub Consortium\n
 * CopyPolicy: Released under the terms of the GNU GPL v2.0.\n
 * This file can be edited at \c $COGNITIVEINTERACTION_ROOT/gazeTracking/include/iCub/gazeTracking.h
 * 
 */
